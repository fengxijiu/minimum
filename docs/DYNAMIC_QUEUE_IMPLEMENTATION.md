...
> 基于 `docs/SUBAGENT_OPTIMISE.md` 方案，将旧调度链路升级为 DAG 驱动的动态调度器。

## 进度总览

| 阶段 | 状态 | 完成时间 |
|------|------|----------|
| Phase 1: DagHarness 接口 + 调度器抽象重构 | ✅ 完成 | 2026-06-03 |
...
| Phase 6: TUI 展示从批次视图切换为 Flow | ✅ 完成 | 2026-06-03 |
...
| 文件 | 改动内容 |
|------|----------|
| `src/orchestration/MiMoPipeline.ts` | 调度入口改为统一 Harness 事件流 |
