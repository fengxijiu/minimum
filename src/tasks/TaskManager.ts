...
import type { TaskDefinition, TaskStatus, TaskPriority, TaskUpdate, TaskHandler } from './types.js';
...
export class TaskManager {
  ...
  constructor(options?: {
    ...
    this.basePath = options?.basePath || path.join(process.env.HOME || '~', '.minimum', 'tasks');
