...
export class Chunker {
  ...
  chunkDocument(path: string, content: string, metadata: Record<string, any> = {}): IndexedDocument[] {
  ...
  private getStartLine(content: string, chunk: string, chunkIndex: number): number {
  ...
  private getEndLine(content: string, chunk: string, chunkIndex: number): number {
